...
function Projetos(){
    ...
    return(<>
        ...
        <div className='geral'>
            ...
            <CardL imagem={<img src={Andar}/>} sobre={'Esse e um projeto feito com minha equipe de faculdade, o primeiro em react '} linguagem={['Javascript','Html','Css','React']} titulo={'4 andar'} link={'https://4-andar.vercel.app'}/>
